...
class ChargeClass(object):
    ...
    def chargePreview(self):
        payload2 = {"cno":"1262797","shop_id":4101315464,"cashier_id":"1196770051","money":"100","award_money2":10,"reward_money":"100","is_diy":"true","charge_type":1,"remark":"beizhu","biz_id":"37","recommenderecode2":9002}


        res = requests.request("POST",self.url,data=newPayload,headers=self.headers)
        return json.dumps(res.text).decode('unicode-escape')
